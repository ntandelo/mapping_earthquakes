...
countries.forEach(country=>{
  ...
  circles.push(
    ...
    .bindPopup(country.name+"<hr>"+country.points)
  )
});
  // Conditionals for countries points

  // Add circles to map
var cityLayers = L.layerGroup(circles);
var allMaps = {
  "Streets": streets,
  "Dark": dark,
  "Light": light,
...
var allLayers = {
  ...
  var myMap = L.map("map", {
    ...
    zoom: 3,
    layers: [satellite, cityLayers]
  });
L.control.layers(allMaps, allLayers).addTo(myMap);
